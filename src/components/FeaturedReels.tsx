...
const FeaturedCard = ({ item, index }: { item: typeof featuredData[0], index: number }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-sm md:text-base lg:text-lg font-display font-light leading-snug group-hover:text-accentPink transition-colors duration-500 tracking-tight">
        {item.title}
      </h3>
    </motion.a>
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col mb-16 gap-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-display font-light tracking-tight mb-4 leading-tight">
        ...
        >
          <a 
            ...
            className="relative overflow-hidden bg-accentPink text-white px-12 py-5 font-bold tracking-[0.2em] text-xs md:text-sm uppercase group rounded-full border border-accentPink transition-all duration-700 w-full md:w-auto text-center flex items-center justify-center shadow-xl"
          >
            <span className="relative z-10 group-hover:text-accentPink transition-colors duration-700 max-w-[200px] md:max-w-none">
